...
export function calculateDamage({
    ...
    let resMult = 1;
    if (enemyRes < 0) resMult = 1 - (enemyRes / 200);
    else if (enemyRes >= 0) resMult = 1 - (enemyRes / 100);
    else if (enemyRes < 80) resMult = 1 - enemyRes / 100;
    else resMult = 1 / (1 + 5 * (enemyRes / 100));
